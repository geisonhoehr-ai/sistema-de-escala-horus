...
export const mockScales: Scale[] = [
  {
    ...
    services: [
      { date: addDays(today, 1), militaryId: 'mil-1' },
      { date: addDays(today, 2), militaryId: 'mil-2' },
      { date: addDays(today, 3), militaryId: 'mil-1' },
    ],
  ...
  },
  {
    ...
    services: [
      { date: addDays(today, 1), militaryId: 'mil-4' },
      { date: addDays(today, 2), militaryId: 'mil-5' },
    ],
    reservations: [],
  },
]
